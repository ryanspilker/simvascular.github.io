...
Most of the <i>Tools</i> produce geometry that can be interactively viewed in the 2D and 3D views of the Display area of the main window. The <i> Data Manager </i> provides an interface for interactively
adding and removing <i>Tool</i> instances and changing some of the properties used to display the geometric data created by a
<i>Tool</i> (e.g., color).
...
<table class="table table-bordered" style="width:100%">
  ...
  <tr>
    <td> Left </td>
    <td> Used to select GUI controls to manage <i>Tool</i> data visibility and expand and collapse the <i>Tool</i> hierarchy </td>
  </tr>

  <tr>
    <td> Left, double-click </td>
    <td> 
      <b> <i>Tool Type</i></b> - Expand and collapse <i>Tool</i> <i>Data Nodes</i> <br><br>
      <b> <i>Tool</i> <i>Data Node</i> </b> - Brings up the <i>Tool</i> panel  </td>
  </tr>

  <tr>
    <td> Right </td>
    <td> Opens a <i>Data Manager</i> menu </td>
  </tr>
...
<table class="table table-bordered" style="width:100%">
  <caption> <b> Data Manager GUI controls </b> </caption>
  <tr>
    <th> Control </th>
    <th> Function </th>
    <th> Example </th>
...
<figure>
  ...
  <figcaption class="svCaption"> Fig. 8 &nbsp; The menu for a <b>Paths</b> Tool Type showing common options in the top portion
...
<table class="table table-bordered" style="width:100%">
  ...
  <tr>
    <td> Color</td>
    <td> Selecting the colored <i>Button</i> brings up a color palette used to change the color of the selected <i>Data Node</i> </td>
  </tr>
...
<table class="table table-bordered" style="width:100%">
  ...
  <tr>
    ...
    <td> 
      ...
      A <i>Project</i> can contain only a single image volume. Adding a new image volume replaces the current one.
      </div>
    </td> 
  </tr>
  ...
  <tr>
    ...
    <td>
      ...
      <i> Import Paths </i> - Create an instance of a <i>Paths</i> tool from <i>Path</i> data contained in a SimVascular .pth or legacy .paths file. <br>
