...
The _Tools_ menu is used to add a SimVascular <i>Tool</i> to the <i>Tool Panel</i>. This does not add a new <i>Tool</i>
...
The other menu items are mostly MITK tools that are not often used.
