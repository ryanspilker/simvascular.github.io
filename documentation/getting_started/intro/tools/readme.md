...
The SimVascular application provides a set of core <i>Tools</i> (a.k.a. plugins) implementing methods for each step in the
...
VTP and VTU <a href="https://vtk.org/wp-content/uploads/2015/04/file-formats.pdf">file formats</a>.
...
<ol>
  <li> <b>Internal</b> - Data used by the <i>Tool</i> is obtained from another <i>Tool</i>.<br>
                         Example: A <i>Models Tool</i> uses segmentations created by a <i>Segmentations Tool</i>. </li>

  <li> <b>External</b> - Data used by the <i>Tool</i> is read in (imported) from a file. The instances of <i>Paths</i>,
                         <i>Segmentations</i>, and <i>Models</i> <i>Tools</i> can be created by reading data from a file.<br>
