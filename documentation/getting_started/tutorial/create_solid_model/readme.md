...
A solid model represents a volume in space by a set of faces with well-defined boundaries connected to form a closed surface.
    ...
    <td> Some GUI controls: <br><br>
         <ul style="list-style-type:none;">
           ...
           <li> <img src="/documentation/getting_started/tutorial/images/model-gui-est-size.png" width="114" height="25"> - Estimate a good
                triangle edge size used to remesh the model's triangular surface.  </li> <br>
...
<table class="table table-bordered" style="width:100%">
  ...
  <tr>
    ...
    <td> Select the <img src="/documentation/getting_started/tutorial/images/model-gui-create-model.png" width="114" height="25"> 
         ...
         <br><br>
         A <b>Create Solid Model</b> <i>DialogBox</i> appears. This displays the names of the <b>aorta</b> and <b>left-iliac</b>
  ...
  <tr>
    ...
    <td> The <b>Face List</b> <i>Table</i> lists the five <i>Faces</i> created by joining the <b>aorta</b> and 
  ...
  <tr>
    <td><img src="/documentation/getting_started/tutorial/images/create-model-10.png" width="512" height="360"> </td>
     <td> Select the <i>Data Manager</i> <i>Paths</i> and <i>Segmentations</i> <i>CheckBox</i>es to toggle off the visibility of 
